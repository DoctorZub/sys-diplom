...
Процесс добавления хостов для мониторинга организован через импорт заранее подготовленного [файла](https://github.com/DoctorZub/sys-diplom/blob/main/main/zabbix/zbx_export_hosts.yaml). Данный файл должен находится на рабочей станции администатора. Для добавления хостов необходимо импортировать данный файл в разделе ???
